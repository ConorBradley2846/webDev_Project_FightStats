...
<html>
  <head>
    ...
    <title>UFC FightData: Sign-up</title>
  ...
  <body class="has-navbar-fixed-top" id="signuppage">
    ...
    <nav class="navbar is-fixed-top is-dark" role="navigation" aria-label="main navigation">
      <div class="navbar-brand">
        <a class="navbar-item" href="\proposal\index.html">
        ...
        <div id="content-wrap">
            ...
            <div class="column is-7 ml-6 mr-6">
                ...
                <div class="box">
                        ...
                        <h1 class="title noFade">Sign Up</h1>

                        <p class="noFade">
                            Sign up to follow and get updates on your favourite fighters and upcoming events, 
                            aswell as post event stats breakdowns
                        </p>

                        <?php
                            if(isset($_GET['exists'])){
                                echo "<h1 class='subtitle noFade'>Account already exists, please login.</h1>";
                                echo "<a class='button is-dark' href='security/login.php'> Log in </a>";
                            }
                        ?>
                    
                        <form action="security/signupprocess.php" method="post">
                          ...
                          <div class="columns noFade">
                              <div class="field is-grouped">
                                  <div class="control">
                                    <input  class="button is-link" name="Signup" type="submit" value="Signup"></input>
                                  </div>
                              </div>
                          </div>
