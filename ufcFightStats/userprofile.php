...
<html>
  <head>
    ...
    <title>UFC Fight Data: User Profile</title>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $.ajax({
                type: "GET",
                url: "http://cbradley75.lampt.eeecs.qub.ac.uk/ufcFightStats/API/getStatsapi.php?favFight&userid=<?php echo $userID; ?>",
                dataType: "json",
            ...
            $.ajax({
                type: "GET",
                url: "http://cbradley75.lampt.eeecs.qub.ac.uk/ufcFightStats/API/getStatsapi.php?favEvent&userid=<?php echo $userID; ?>",
                dataType: "json",
                success: function(res){
          ...
          <div class="column is-full mb-4 px-2">
            <div class="box">
                    ...
                    <h1 class="title fighterTitle noFade">
                        <strong> Your favorited fights: </strong>
                    </h1>
        ...
        <div class="row" id="indexmaincards">
          <div class="column is-full mb-4 px-2">
            <div class="box">
                    <div class="table-container">
                    <h1 class="title fighterTitle noFade">
                        <strong> Your favorited Events: </strong>
                    </h1>
